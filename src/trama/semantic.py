...
_BUILTIN_ARITY: dict[str, int | None] = {
    ...
    "armazenamento_definir_politicas": None,
    "armazenamento_iniciar_upload": None,
    "armazenamento_upload_escrever": 3,
    "armazenamento_upload_finalizar": None,
    "armazenamento_processar_upload": None,
    "armazenamento_promover": None,
    "armazenamento_ler": 2,
    "armazenamento_metadados": 2,
    "armazenamento_remover": 2,
    "armazenamento_listar": None,
    "armazenamento_url": None,
    "armazenamento_url_assinada": None,
    "midia_ler_arquivo": 1,
    ...
    "midia_pipeline": None,
    "midia_extrair_metadados": 1,
    "midia_pipeline_storage": None,
    "agora_iso": 0,
    "timestamp": 0,
    "web_criar_app": 0,
    ...
    "web_gerar_ir_contrato": None,
    "web_exportar_ir_contrato": None,
    "web_contrato_ir_gerar": None,
    "web_contrato_ir_exportar": None,
    ...
    "jwt_validar": None,
    "jwks_obter": None,
    "jwt_validar_jwks": None,
    "oidc_descobrir_configuracao": None,
    "oidc_configurar_provedor": None,
    "oidc_validar_token": None,
    "oidc_listar_provedores": 0,
    "oidc_remover_provedor": 1,
    "senha_hash": None,
    "senha_verificar": 2,
    "rbac_criar": None,
    "rbac_atribuir": 3,
    ...
    "autorizacao_politicas_criar": None,
    "autorizacao_politicas_avaliar": None,
    "autorizacao_avaliar": None,
    ...
    "token_assinar": None,
    "token_validar": None,
    "token_validar_jwks": None,
    "autenticacao_oidc_descobrir": None,
    "autenticacao_oidc_configurar": None,
    "autenticacao_oidc_validar": None,
    ...
    "papel_tem": 3,
    "permissao_tem": 4,
    "politica_autorizacao_criar": None,
    "politica_autorizacao_avaliar": None,
    ...
    "tracas_reset": 0,
    "fila_criar": 1,
    "fila_criar_com_backend": None,
    "fila_enfileirar": None,
    "fila_processar": 1,
    "fila_status": 1,
    "fila_listar_dlq": None,
    "fila_obter_job": 2,
    "fila_reprocessar_dlq": None,
    "fila_backends_listar": 0,
    "webhook_enviar": None,
}
