...
class Compiler:
    ...
    def compile(self, program: Program) -> BytecodeProgram:
        entry_compiler = _FunctionCompiler(code_name="__entry__", display_name="__entry__", params=[])
    ...
    def _compile_function_decl(self, decl: FunctionDecl) -> str:
        ...
        fn = _FunctionCompiler(code_name=code_name, display_name=decl.name, params=decl.params)
    ...
    def _compile_stmt(self, fn: _FunctionCompiler, stmt: Stmt) -> None:
        if isinstance(stmt, FunctionDecl):
            ...
            fn.emit("MAKE_FUNCTION", (stmt.name, code_name))
